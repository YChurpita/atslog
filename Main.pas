...
begin
  ...
  m.ActiveWorkBook.WorkSheets[1].Cells.Item[1,1]:= 'Звонки  по  данным офисной АТС Panasonic TX-100 '   ;
  ...
  m.ActiveWorkBook.WorkSheets[1].Cells.Item[2,1]:= 'Пользователь' ;
  m.ActiveWorkBook.WorkSheets[1].Cells.Item[2,2]:= 'Линия' ;
  m.ActiveWorkBook.WorkSheets[1].Cells.Item[2,3]:= 'Номер телефона' ;
  m.ActiveWorkBook.WorkSheets[1].Cells.Item[2,4]:= 'Время в сикунах';
  m.ActiveWorkBook.WorkSheets[1].Cells.Item[2,5]:= 'Тип звонка';
